...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView textView, x, y, z, raw_data, constate, IX, IY, IZ,test_state;
    //連線端變數定義
    ...
    private Runnable readData = new Runnable() {
        public void run() {
            ...
            try {
                ...
                serverIp = InetAddress.getByName("192.168.210.105"); //10.0.2.2
                int serverPort = 5000;
...
//        z = (TextView) findViewById(R.id.data_z);
        ...
        IY = (TextView) findViewById(R.id.Y_ID);
        IZ = (TextView) findViewById(R.id.Z_ID);
    ...
    float[][] parseTLV(byte[] fileBytes){
        ...
        int point_count =10;
        float [][] point_cloud=new float[3][point_count];
